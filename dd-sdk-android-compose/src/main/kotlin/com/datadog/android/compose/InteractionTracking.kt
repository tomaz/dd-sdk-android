...
sealed class InteractionType {
     ...
     * @param reverseDirection Whether the direction of the swipe is reversed, so a top to bottom
     * swipe behaves like bottom to top, and a left to right swipe behaves
     * like right to left. Same as the value of [Modifier.swipeable].
     */
    class Swipe<T : Any>(
